...
#pragma region ECS
		...
		static void Actor_AddComponent(uint64_t actorID, MonoReflectionType* componentType);
		static void Actor_RmvComponent(uint64_t actorID, MonoReflectionType* componentType);
#pragma endregion
