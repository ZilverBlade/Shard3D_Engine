...
namespace Shard3D {
    ...
    uPtr<EngineDescriptorSetLayout> EngineDescriptorSetLayout::Builder::build() const {
        return make_uPtr<EngineDescriptorSetLayout>(engineDevice, bindings);
    }
    ...
    uPtr<EngineDescriptorPool> EngineDescriptorPool::Builder::build() const {
        return make_uPtr<EngineDescriptorPool>(engineDevice, maxSets, poolFlags, poolSizes);
    }
