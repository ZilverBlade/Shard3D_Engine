...
#pragma endregion	
	...
	class _special_assets {
		...
		inline static const char* _editor_icons_array[][2]{
			...
			{"editor.load",						"assets/_engine/tex/_editor/icon_null"			},
			...
			{"editor.level",					"assets/_engine/tex/_editor/icon_null"			},
			{"editor.load",						"assets/_engine/tex/_editor/icon_null"			},
			...
			{"component.light.point",			"assets/_engine/tex/_editor/icon_null"			},
			{"component.light.spot",			"assets/_engine/tex/_editor/icon_null"			},
			{"component.light.directional",		"assets/_engine/tex/_editor/icon_null"			},
